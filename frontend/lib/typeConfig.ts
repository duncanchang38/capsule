export const TYPE_CONFIG = {
  ...
  to_cook:  { label: "To Cook",  sourceLabel: "Ideas",     displayLabel: "Idea",     color: "#ec4899", bgClass: "bg-purple-100 text-purple-700", doneLabel: "",         doneStatus: "" },
  ...
  calendar: { label: "Event",    sourceLabel: "Events",    displayLabel: "Event",    color: "#3b82f6", bgClass: "bg-blue-50 text-blue-600",     doneLabel: "",         doneStatus: "" },
} as const;
